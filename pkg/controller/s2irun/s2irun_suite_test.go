...
var controller *s2irun.S2iRunController
var si *sharedinformers.SharedInformers

func TestS2iRun(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "S2iRun Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = s2irun.NewS2iRunController(config, si)
