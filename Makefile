...
debug: build-binary
	apiserver-boot run local --run=apiserver --run=controller-manager --etcd "http://192.168.98.8:2379" --generate=false --build=false --controller-args="-logtostderr=true" --controller-args="-v=1"  --apiserver-args="--loglevel=2"
build-doc:
