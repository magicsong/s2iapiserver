...
var controller *ksbuilder.KsBuilderController
var si *sharedinformers.SharedInformers

func TestKsBuilder(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecsWithDefaultAndCustomReporters(t, "KsBuilder Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	controller = ksbuilder.NewKsBuilderController(config, si)
