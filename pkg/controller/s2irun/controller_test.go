...
var _ = Describe("S2iRun controller", func() {
	var instance S2iRun
	...
	BeforeEach(func() {
		...
		expectedKey = "s2irun-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.DevopsV1alpha1().S2iRuns("s2irun-controller-test-handler")
