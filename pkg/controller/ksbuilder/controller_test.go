...
var _ = Describe("KsBuilder controller", func() {
	var instance KsBuilder
	var expectedKey string
	var client KsBuilderInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "ksbuilder-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.DevopsV1alpha1().KsBuilders("ksbuilder-controller-test-handler")
