...
var _ = Describe("KsBuilderRun controller", func() {
	var instance KsBuilderRun
	var expectedKey string
	var client KsBuilderRunInterface
	var before chan struct{}
	var after chan struct{}

	BeforeEach(func() {
		instance = KsBuilderRun{}
		instance.Name = "instance-1"
		expectedKey = "ksbuilderrun-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.DevopsV1alpha1().KsBuilderRuns("ksbuilderrun-controller-test-handler")
