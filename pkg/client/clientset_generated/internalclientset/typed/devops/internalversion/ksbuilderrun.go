...
type KsBuilderRunInterface interface {
	Create(*devops.KsBuilderRun) (*devops.KsBuilderRun, error)
	Update(*devops.KsBuilderRun) (*devops.KsBuilderRun, error)
	UpdateStatus(*devops.KsBuilderRun) (*devops.KsBuilderRun, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*devops.KsBuilderRun, error)
	List(opts v1.ListOptions) (*devops.KsBuilderRunList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *devops.KsBuilderRun, err error)
...
func newKsBuilderRuns(c *DevopsClient, namespace string) *ksBuilderRuns {
...
func (c *ksBuilderRuns) Get(name string, options v1.GetOptions) (result *devops.KsBuilderRun, err error) {
	result = &devops.KsBuilderRun{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *ksBuilderRuns) List(opts v1.ListOptions) (result *devops.KsBuilderRunList, err error) {
	result = &devops.KsBuilderRunList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("ksbuilderruns").
...
func (c *ksBuilderRuns) Create(ksBuilderRun *devops.KsBuilderRun) (result *devops.KsBuilderRun, err error) {
	result = &devops.KsBuilderRun{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("ksbuilderruns").
...
func (c *ksBuilderRuns) Update(ksBuilderRun *devops.KsBuilderRun) (result *devops.KsBuilderRun, err error) {
	result = &devops.KsBuilderRun{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ksbuilderruns").
...
func (c *ksBuilderRuns) UpdateStatus(ksBuilderRun *devops.KsBuilderRun) (result *devops.KsBuilderRun, err error) {
	result = &devops.KsBuilderRun{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("ksbuilderruns").
...
func (c *ksBuilderRuns) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *devops.KsBuilderRun, err error) {
	result = &devops.KsBuilderRun{}
