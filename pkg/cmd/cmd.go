...
// NewKSOptions provides an instance of KSOptions with default values
func NewKSOptions(streams genericclioptions.IOStreams) *KSOptions {
	return &KSOptions{
...
func NewKSCmd(stream genericclioptions.IOStreams) *cobra.Command {
	o := NewKSOptions(streams)

	cmd := &cobra.Command{
		Use:          "ks rerun [new-namespace] [flags]",
