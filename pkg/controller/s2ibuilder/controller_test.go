...
var _ = Describe("S2iBuilder controller", func() {
	var instance S2iBuilder
	var expectedKey string
	var client S2iBuilderInterface
	...
	BeforeEach(func() {
		...
		expectedKey = "s2ibuilder-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.DevopsV1alpha1().S2iBuilders("s2ibuilder-controller-test-handler")
